...
public class schedulityDbContext :
    AbpDbContext<schedulityDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public schedulityDbContext(DbContextOptions<schedulityDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(schedulityConsts.DbTablePrefix + "YourEntities", schedulityConsts.DbSchema);
